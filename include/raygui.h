...
static unsigned int guiIcons[RAYGUI_ICON_MAX_ICONS * RAYGUI_ICON_DATA_ELEMENTS] = {
    ...
    0x40024002,
    0x40024002,
    0x00007ffe, // ICON_FOLDER_FILE_OPEN
    0x3ffe0000,
    0x44226422,
    0x400247e2,
    0x5ffa4002,
    ...
    0x500a500a,
    0x40025ffa,
    0x00007ffe, // ICON_FILE_SAVE_CLASSIC
    0x00000000,
    0x0042007e,
    0x40027fc2,
    0x40024002,
    ...
    0x20642664,
    0x20042004,
    0x00003ffc, // ICON_FILETYPE_AUDIO
    0x3ff00000,
    0x201c2010,
    0x26042604,
    0x20042004,
    ...
    0x2414222c,
    0x20042004,
    0x00003ffc, // ICON_FILETYPE_IMAGE
    0x3ff00000,
    0x201c2010,
    0x20c42004,
    0x22442144,
    ...
    0x3f3c2eb4,
    0x3ffc2ff4,
    0x00002ff4, // ICON_FILETYPE_VIDEO
    0x3ff00000,
    0x201c2010,
    0x21842184,
    0x21842004,
    ...
    0x04400840,
    0x01800280,
    0x00000000, // ICON_CURSOR_POINTER
    0x00000000,
    0x00180000,
    0x01f00078,
    0x03e007f0,
    ...
    0x04000e40,
    0x00000000,
    0x00000000, // ICON_CURSOR_CLASSIC
    0x00000000,
    0x04000000,
    0x11000a00,
    0x04400a80,
    ...
    0x001c0020,
    0x001c001c,
    0x00000000, // ICON_FILTER_BILINEAR
    0x40080000,
    0x1ffe2008,
    0x14081008,
    0x11081208,
    ...
    0x0d501d48,
    0x01000560,
    0x00000100, // ICON_SYMMETRY_HORIZONTAL
    0x01800000,
    0x04200240,
    0x10080810,
    0x00001ff8,
    ...
    0x0ff01ff8,
    0x03c007e0,
    0x00000180, // ICON_SYMMETRY_VERTICAL
    0x00000000,
    0x010800f0,
    0x02040204,
    0x02040204,
    ...
    0x00140024,
    0x003c0004,
    0x00000000, // ICON_CURSOR_SCALE_RIGHT
    0x00000000,
    0x0004003c,
    0x00240014,
    0x00800040,
    ...
    0x28002400,
    0x3c002000,
    0x00000000, // ICON_CURSOR_SCALE_LEFT
    0x00000000,
    0x00100020,
    0x10101fc8,
    0x10001020,
    ...
    0x00800080,
    0x00800080,
    0x00000000, // ICON_TARGET_SMALL_FILL
    0x00800000,
    0x00800080,
    0x03e00080,
    0x3ffe03e0,
    ...
    0x00800080,
    0x00800080,
    0x00000000, // ICON_TARGET_BIG_FILL
    0x01000000,
    0x07c00380,
    0x01000100,
    0x638c2008,
    ...
    0x01002008,
    0x07c00100,
    0x01000380, // ICON_TARGET_MOVE_FILL
    0x01000000,
    0x07c00380,
    0x01000100,
    0x610c2108,
    ...
    0x01002108,
    0x07c00100,
    0x01000380, // ICON_CURSOR_MOVE_FILL
    0x781e0000,
    0x6006700e,
    0x04204812,
    0x00000240,
    ...
    0x48120420,
    0x700e6006,
    0x0000781e, // ICON_CURSOR_SCALE_FILL
    0x00000000,
    0x38003c00,
    0x24003000,
    0x01000200,
    ...
    0x000c0024,
    0x003c001c,
    0x00000000, // ICON_CURSOR_SCALE_RIGHT_FILL
    0x00000000,
    0x001c003c,
    0x0024000c,
    0x00800040,
    ...
    0x30002400,
    0x3c003800,
    0x00000000, // ICON_CURSOR_SCALE_LEFT_FILL
    0x00000000,
    0x00300020,
    0x10301ff8,
    0x10001020,
    ...
    0x20142024,
    0x3ffc200c,
    0x00000000, // ICON_EMPTYBOX_SMALL
    0x00000000,
    0x20043ffc,
    0x20042004,
    0x20042004,
    ...
    0x3e043e04,
    0x3ffc3e04,
    0x00000000, // ICON_BOX_BOTTOM_RIGHT
    0x00000000,
    0x20043ffc,
    0x20042004,
    0x20042004,
    ...
    0x207c207c,
    0x3ffc207c,
    0x00000000, // ICON_BOX_BOTTOM_LEFT
    0x00000000,
    0x20043ffc,
    0x20042004,
    0x207c207c,
    ...
    0x418247e2,
    0x40024002,
    0x00007ffe, // ICON_BOX_CIRCLE_MASK
    0x7fff0000,
    0x40014001,
    0x40014001,
    0x49555ddd,
    ...
    0x48125432,
    0x4006540e,
    0x00007ffe, // ICON_ALPHA_MULTIPLY
    0x7ffe0000,
    0x53327332,
    0x44ce4cce,
    0x41324332,
    ...
    0x17e81c38,
    0x00001c38,
    0x00000000, // ICON_BOX_CORNERS_SMALL
    0x700e0000,
    0x700e5ffa,
    0x20042004,
    0x20042004,
    ...
    0x20042004,
    0x5ffa700e,
    0x0000700e, // ICON_BOX_CORNERS_BIG
    0x3f7e0000,
    0x21422142,
    0x21422142,
    0x00003f7e,
    ...
    0x10081008,
    0x00001db8,
    0x00000000, // ICON_BOX_DOTS_SMALL
    0x35560000,
    0x00002002,
    0x00002002,
    0x00002002,
    ...
    0x4ff24812,
    0x40024002,
    0x00007ffe, // ICON_BOX_CONCENTRIC
    0x00000000,
    0x10841ffc,
    0x10841084,
    0x1ffc1084,
    ...
    0x038003c0,
    0x02000300,
    0x00000000, // ICON_ARROW_LEFT_FILL
    0x00000000,
    0x00400000,
    0x01c000c0,
    0x07c003c0,
    ...
    0x01c003c0,
    0x004000c0,
    0x00000000, // ICON_ARROW_RIGHT_FILL
    0x00000000,
    0x00000000,
    0x00000000,
    0x0ff81ffc,
    ...
    0x008001c0,
    0x00000000,
    0x00000000, // ICON_ARROW_DOWN_FILL
    0x00000000,
    0x00000000,
    0x01c00080,
    0x07f003e0,
    ...
    0x00000000,
    0x00000000,
    0x00000000, // ICON_WAVE_TRIANGULAR
    0x00000000,
    0x00000000,
    0x04200000,
    0x01800240,
    ...
    0x14281228,
    0x00001838,
    0x00000000, // ICON_PLAYER_PREVIOUS
    0x00000000,
    0x18000000,
    0x11801600,
    0x10181060,
    ...
    0x16001180,
    0x00001800,
    0x00000000, // ICON_PLAYER_PLAY_BACK
    0x00000000,
    0x00180000,
    0x01880068,
    0x18080608,
    ...
    0x241e75fe,
    0x0c06140e,
    0x000007fe, // ICON_CUBE_FACE_LEFT
    0x7fe00000,
    0x50286030,
    0x47fe4804,
    0x47fe47fe,
    ...
    0x27fe77fe,
    0x0ffe17fe,
    0x000007fe, // ICON_CUBE_FACE_FRONT
    0x7fe00000,
    0x50286030,
    0x47fe4804,
    0x44224402,
    ...
    0x3bf27be2,
    0x0bfe1bfa,
    0x000007fe, // ICON_CUBE_FACE_BOTTOM
    0x7fe00000,
    0x70286030,
    0x7ffe7804,
    0x7c227c02,
    ...
    0x3c127de2,
    0x0c061c0a,
    0x000007fe, // ICON_CUBE_FACE_RIGHT
    0x7fe00000,
    0x6fe85ff0,
    0x781e77e4,
    0x7be27be2,
    ...
    0x24127be2,
    0x0c06140a,
    0x000007fe, // ICON_CUBE_FACE_BACK
    0x00000000,
    0x2a0233fe,
    0x22022602,
    0x22022202,
    ...
    0x80028382,
    0xfffe8002,
    0x00000000, // ICON_PHOTO_CAMERA_FLASH
    0x00000000,
    0x02400180,
    0x08100420,
    0x20041008,
    ...
    0x1b6c1b6c,
    0x1b6c1b6c,
    0x00000000, // ICON_VERTICAL_BARS_FILL
    0x00000000,
    0x00000000,
    0x403e7ffe,
    0x7ffe403e,
    ...
    0x2aac3554,
    0x2aac3554,
    0x00003ffc, // ICON_FILETYPE_ALPHA
    0x3ff00000,
    0x201c2010,
    0x22442184,
    0x28142424,
    ...
    0x402047fe,
    0x40204020,
    0x00007fe0, // ICON_LAYERS_VISIBLE
    0x07fe0000,
    0x04020402,
    0x7c020402,
    0x44024402,
    ...
    0x2aa42aa4,
    0x20042ba4,
    0x00003ffc, // ICON_FILETYPE_BINARY
    0x00000000,
    0x00000000,
    0x00120012,
    0x4a5e4bd2,
    ...
    0x03c00420,
    0x00000000,
    0x00000000, // ICON_BREAKPOINT_OFF
    0x00000000,
    0x00000000,
    0x1ff81ff8,
    0x1ff80000,
    ...
    0x3e881288,
    0x00000000,
    0x00000000, // ICON_CASE_SENSITIVE
    0x00000000,
    0x02000000,
    0x07000a80,
    0x07001fc0,
    ...
    0x50125552,
    0x10105016,
    0x00001ff0, // ICON_MANUAL_CONTROL
    0x7ffe0000,
    0x43c24002,
    0x48124422,
    0x500a500a,
    ...
    0x3e7c3e7c,
    0x0ff01ff8,
    0x000003c0, // ICON_CIRCLE_ADD_FILL
    0x03c00000,
    0x10080c30,
    0x21842184,
    0x41824182,
    ...
    0x21842184,
    0x0c301008,
    0x000003c0, // ICON_CIRCLE_WARNING
    0x03c00000,
    0x1ff80ff0,
    0x3e7c3e7c,
    0x7e7e7e7e,
    ...
    0x3e7c3e7c,
    0x0ff01ff8,
    0x000003c0, // ICON_CIRCLE_WARNING_FILL
    0x00000000,
    0x10041ffc,
    0x10841004,
    0x13e41084,
    ...
    0x10041004,
    0x00001ffc,
    0x00000000, // ICON_BOX_MINUS_FILL
    0x07fe0000,
    0x055606aa,
    0x7ff606aa,
    0x55766eba,
    ...
    0x21c42054,
    0x20042004,
    0x00003ffc, // ICON_FILETYPE_PYTHON
    0x3ff00000,
    0x201c2010,
    0x20042004,
    0x20042004,
...
#define RAYGUI_PANEL_BORDER_WIDTH 1
    ...
    //--------------------------------------------------------------------
    if (text != NULL)
        result = GuiStatusBar(statusBar, text); // Draw panel header as status bar
    ...
    *view = (GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE) ? RAYGUI_CLITERAL(Rectangle){bounds.x + verticalScrollBarWidth + GuiGetStyle(DEFAULT, BORDER_WIDTH), bounds.y + GuiGetStyle(DEFAULT, BORDER_WIDTH), bounds.width - 2 * GuiGetStyle(DEFAULT, BORDER_WIDTH) - verticalScrollBarWidth, bounds.height - 2 * GuiGetStyle(DEFAULT, BORDER_WIDTH) - horizontalScrollBarWidth} : RAYGUI_CLITERAL(Rectangle){bounds.x + GuiGetStyle(DEFAULT, BORDER_WIDTH), bounds.y + GuiGetStyle(DEFAULT, BORDER_WIDTH), bounds.width - 2 * GuiGetStyle(DEFAULT, BORDER_WIDTH) - verticalScrollBarWidth, bounds.height - 2 * GuiGetStyle(DEFAULT, BORDER_WIDTH) - horizontalScrollBarWidth};
    ...
    if ((state != STATE_DISABLED) && !guiLocked)
    {
        ...
        if (CheckCollisionPointRec(mousePoint, bounds))
        {
            ...
            if (hasHorizontalScrollBar && (GUI_KEY_DOWN(KEY_LEFT_CONTROL) || GUI_KEY_DOWN(KEY_LEFT_SHIFT)))
...
int GuiLabelButton(Rectangle bounds, const char *text)
{
    ...
    if ((bounds.width - 2 * GuiGetStyle(LABEL, BORDER_WIDTH) - 2 * GuiGetStyle(LABEL, TEXT_PADDING)) < textWidth)
        bounds.width = textWidth + 2 * GuiGetStyle(LABEL, BORDER_WIDTH) + 2 * GuiGetStyle(LABEL, TEXT_PADDING) + 2;
...
int GuiDropdownBox(Rectangle bounds, const char *text, int *active, bool editMode)
{
    ...
    if ((state != STATE_DISABLED) && (editMode || !guiLocked) && (itemCount > 1) && !guiControlExclusiveMode)
    {
        ...
        if (editMode)
        {
            ...
            if (CheckCollisionPointRec(mousePoint, bounds) && GUI_BUTTON_PRESSED)
                result = 1;
...
#define RAYGUI_TEXTBOX_AUTO_CURSOR_DELAY 1 // Frames delay for autocursor movement
            ...
            if ((textLength > textBoxCursorIndex) && GUI_KEY_PRESSED(KEY_DELETE) && (GUI_KEY_DOWN(KEY_LEFT_CONTROL) || GUI_KEY_DOWN(KEY_RIGHT_CONTROL)))
            {
                ...
                while (offset < textLength)
                {
                    if ((puctuation && !ispunct(nextCodepoint & 0xff)) ||
                        (!puctuation && (isspace(nextCodepoint & 0xff) || ispunct(nextCodepoint & 0xff))))
                        break;
                ...
                (GUI_KEY_DOWN(KEY_LEFT_CONTROL) || GUI_KEY_DOWN(KEY_RIGHT_CONTROL)))
            {
                ...
                while (offset > 0)
                {
                    ...
                    if ((puctuation && !ispunct(prevCodepoint & 0xff)) ||
                        (!puctuation && (isspace(prevCodepoint & 0xff) || ispunct(prevCodepoint & 0xff))))
                        break;
    ...
    if (editMode && !GuiGetStyle(TEXTBOX, TEXT_READONLY))
    {
        ...
        if (mouseCursor.x >= 0)
            GuiDrawRectangle(mouseCursor, 0, BLANK, GetColor(GuiGetStyle(TEXTBOX, BORDER_COLOR_PRESSED)));
    }
    else if (state == STATE_FOCUSED)
        GuiTooltip(bounds);
    //--------------------------------------------------------------------
    ...
    if ((state != STATE_DISABLED) && !guiLocked && !guiControlExclusiveMode)
    {
        ...
        if (editMode)
        {
            ...
            if ((GUI_KEY_PRESSED(KEY_ENTER) || GUI_KEY_PRESSED(KEY_KP_ENTER)) ||
                (!CheckCollisionPointRec(mousePoint, bounds) && GUI_BUTTON_PRESSED))
                result = RESULT_PRESSED;
        }
        else
        {
...
int GuiSlider(Rectangle bounds, const char *textLeft, const char *textRight, float *value, float minValue, float maxValue)
{
    ...
    if (state == STATE_NORMAL)
        ...
        GuiDrawRectangle(slider, 0, BLANK, GetColor(GuiGetStyle(SLIDER, TEXT_COLOR_DISABLED)));
...
int GuiProgressBar(Rectangle bounds, const char *textLeft, const char *textRight, float *value, float minValue, float maxValue)
{
    ...
    else
    {
        if (*value > minValue)
        {
            ...
            GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){bounds.x, bounds.y, (float)GuiGetStyle(PROGRESSBAR, BORDER_WIDTH), bounds.height + GuiGetStyle(PROGRESSBAR, BORDER_WIDTH) - 1}, 0, BLANK, GetColor(GuiGetStyle(PROGRESSBAR, BORDER_COLOR_NORMAL)));

        if (*value >= maxValue)
            GuiDrawRectangle(RAYGUI_CLITERAL(Rectangle){bounds.x + progress.width + (float)GuiGetStyle(PROGRESSBAR, BORDER_WIDTH), bounds.y, (float)GuiGetStyle(PROGRESSBAR, BORDER_WIDTH), bounds.height + GuiGetStyle(PROGRESSBAR, BORDER_WIDTH) - 1}, 0, BLANK, GetColor(GuiGetStyle(PROGRESSBAR, BORDER_COLOR_FOCUSED)));
        else
        {
...
int GuiListViewEx(Rectangle bounds, char **text, int count, int *scrollIndex, int *active, int *focus)
{
    ...
    if ((GuiGetStyle(LISTVIEW, LIST_ITEMS_HEIGHT) + GuiGetStyle(LISTVIEW, LIST_ITEMS_SPACING)) * count > bounds.height)
        useScrollBar = true;
    ...
    for (int i = 0; ((i < visibleItems) && (text != NULL)); i++)
    {
        ...
        if (state == STATE_DISABLED)
        {
            if ((startIndex + i) == itemSelected)
                GuiDrawRectangle(itemBounds, GuiGetStyle(LISTVIEW, LIST_ITEMS_BORDER_WIDTH), GetColor(GuiGetStyle(LISTVIEW, BORDER_COLOR_DISABLED)), GetColor(GuiGetStyle(LISTVIEW, BASE_COLOR_DISABLED)));
...
int GuiTabBarEx(Rectangle bounds, char **text, int count, int *hscroll, int *active, int *focus)
{
    ...
    for (int i = 0; i < count; i++)
    {
        ...
        if (tabBounds.x < GetScreenWidth())
        {
            ...
            if (CheckCollisionPointRec(GUI_POINTER_POSITION, tabBounds) && GUI_BUTTON_PRESSED_MID)
                result = RESULT_TAB_CLOSE;
    ...
    // NOTE: In case of tab close result, consider focused tab
    if ((result != RESULT_TAB_CLOSE) && (prevActive != *active))
        result = RESULT_CHANGED;
...
int GuiColorPickerHSV(Rectangle bounds, const char *text, Vector3 *colorHsv)
{
    ...
    if (result == RESULT_NONE)
        result = GuiColorBarHue(boundsHue, NULL, &colorHsv->x);
...
#define RAYGUI_TEXTINPUTBOX_HEIGHT 26
    ...
    if (secretViewActive != NULL)
    {
        ...
        if (GuiTextBox(RAYGUI_CLITERAL(Rectangle){textBoxBounds.x, textBoxBounds.y, textBoxBounds.width - 4 - RAYGUI_TEXTINPUTBOX_HEIGHT, textBoxBounds.height},
                       ((*secretViewActive == 1) || textEditMode) ? text : stars, textSize, textEditMode) == RESULT_PRESSED)
                ...
                case 'f':
                {
                    ...
                    if (fontFileName[0] != '\0')
                    {
                        ...
                        if (codepointCount > 0)
                            ...
                            font = LoadFontEx(TextFormat("%s/%s", GetDirectoryPath(fileName), fontFileName), fontSize, NULL, 0); // Default to 95 standard codepoints
                    }
...
void GuiLoadStyleFromMemory(const unsigned char *fileData, int dataSize)
{
        ...
        (signature[3] == ' '))
    {
        ...
        if (fontDataSize > 0)
        {
            ...
            if (guiIconFontOffsetY > 0)
                fontWhiteRec = updatedWhiteRec;
#endif
...
#define RAYGUI_ICON_TEXT_PADDING 4
    ...
    if ((text != NULL) && (text[0] != '\0'))
    {
        ...
        if (textIconOffset > 0)
            textSize.x += (RAYGUI_ICON_SIZE + RAYGUI_ICON_TEXT_PADDING);
    }
    ...
    for (int i = 0; i < lineCount; i++)
    {
        ...
        if (iconId >= 0)
        {
            ...
            if ((lines[i] != NULL) && (lines[i][0] != '\0'))
                textSizeX += RAYGUI_ICON_TEXT_PADDING;
#endif
        }
        ...
        if (textSizeX > textBounds.width && (lines[i] != NULL) && (lines[i][0] != '\0'))
            textBoundsPosition.x = textBounds.x;
        ...
        for (int c = 0, codepointSize = 0; c < lineSize; c += codepointSize)
        {
            ...
            if (codepoint == 0x3f)
                codepointSize = 1; // WARNING: Not recognized codepoints size
            ...
            else
            {
                ...
                if (guiFont.glyphs[index].advanceX == 0)
                    ...
                    textOffsetX += ((float)guiFont.glyphs[index].advanceX * scaleFactor + (float)GuiGetStyle(DEFAULT, TEXT_SPACING));
            }
        }

        if (wrapMode == TEXT_WRAP_NONE)
            posOffsetY += (float)(GuiGetStyle(DEFAULT, TEXT_SIZE) + GuiGetStyle(DEFAULT, TEXT_LINE_SPACING));
        else if ((wrapMode == TEXT_WRAP_CHAR) || (wrapMode == TEXT_WRAP_WORD))
...
static int GuiScrollBar(Rectangle bounds, int value, int minValue, int maxValue)
{
    ...
    if (sliderSize < 1)
        sliderSize = 1; // Consider a minimum slider size of 1 pixel
...
static int GuiFontIconBaking(Image *imFont, Font font, Rectangle *whiteRec)
{
    ...
    {
        int newImHeight = 1;
        while (newImHeight < (maxGlyphRecY + reqHeight))
            newImHeight <<= 1; // Round to next POT
    ...
    int offsetY = ((maxGlyphRecY + (RAYGUI_ICON_SIZE + 2 * RAYGUI_ICON_FONT_ATLAS_PADDING - 1)) /
                   (RAYGUI_ICON_SIZE + 2 * RAYGUI_ICON_FONT_ATLAS_PADDING)) *
                      (RAYGUI_ICON_SIZE + 2 * RAYGUI_ICON_FONT_ATLAS_PADDING) +
...
#define RAYGUI_TEXTSPLIT_MAX_TEXT_SIZE 1024 // WARNING: Max expected size for all concat items
    ...
    for (int i = 0; i < RAYGUI_TEXTSPLIT_MAX_TEXT_SIZE; i++)
    {
        ...
        else if ((buffer[i] == delimiter) || (buffer[i] == '\n'))
        {
            ...
            itemCounter++;
            if (itemCounter >= RAYGUI_TEXTSPLIT_MAX_ITEMS)
                break;
        }
    }
